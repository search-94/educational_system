...
@section('libraries')
  @parent
  {{HTML::style('css/student/account/password.css')}}
  {{HTML::script('js/student/account/password.js')}}
    <script>
...
<h1 class="text-center">@lang('account.manage')</h1> 
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          {{Form::open(array('action' => 'StudentAccountController@update', 'class' => 'form-horizontal'))}}
