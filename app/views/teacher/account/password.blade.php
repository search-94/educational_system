...
@section('libraries')
  @parent
  {{HTML::style('css/teacher/account/password.css')}}
  {{HTML::script('js/teacher/account/password.js')}}
    <script>
...
<h1 class="text-center">@lang('account.manage')</h1> 
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          {{Form::open(array('action' => 'TeacherAccountController@update', 'class' => 'form-horizontal'))}}
