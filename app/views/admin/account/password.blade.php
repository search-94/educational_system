...
@section('libraries')
  @parent
  {{HTML::style('css/admin/account/password.css')}}
  {{HTML::script('js/admin/account/password.js')}}
    <script>
...
<h1 class="text-center">@lang('account.manage')</h1> 
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              {{Form::open(array('action' => 'AdminAccountController@update', 'class' => 'form-horizontal'))}}
